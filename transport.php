...
<html>
  <head>
    <meta charset="utf-8">
    <title>Transportation Network Input</title>
  ...
  <body>
      ...
      <ul>
          ...
          <li style="float:right"><a href="transport.php">Transport</a></li>
    ...
    <!--topbar code ends-->
  	...
  	<form name="transport" action="transport.php" method="post">
        	<table>
				<tr>
				...
				<tr><br>
					Route<br><textarea name="route" rows="5" cols="55" placeholder="Enter the route of operation"></textarea>
				</tr>
				<tr><br>
...
if(isset($_POST["save"])) //name of the submit button is save
	...
	$query="INSERT INTO `transport`(`name`, `contact`, `route`, `place`) VALUES ('$a','$b','$c','$d')";
