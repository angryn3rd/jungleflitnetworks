...
<html>
  <head>
    <meta charset="utf-8">
    <title>Stays Network Input</title>
  ...
  <body>
      ...
      <ul>
          ...
          <li style="float:right"><a href="stays.php">Stays</a></li>
      </ul>
     
    <!--topbar code ends-->

  	<form name="stays" action="stays.php" method="post">
        	<table>
				<tr>
					Name<br><input type="text" name="name" placeholder="Enter name of connection and stay" size="47px"/>
				</tr>
				<tr><br>
					Contact <br>+91<input type="text" name="contact" placeholder="Phone No."/>
				</tr>
				<tr><br>
					Address<br><textarea name="address" rows="5" cols="55" placeholder="Enter the address"></textarea>
				</tr>
				<tr><br>
...
if(isset($_POST["save"])) //name of the submit button is save
	...
	$query="INSERT INTO `stays`(`name`, `contact`, `address`, `place`) VALUES ('$a','$b','$c','$d')";
